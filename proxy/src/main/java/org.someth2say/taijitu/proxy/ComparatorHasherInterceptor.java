...
public class ComparatorHasherInterceptor<T, EQ extends ComparatorHasher<T>> extends EqualizableInterceptor<T, EQ>
        implements IComparatorInterceptor<T,EQ>, IHasherInterceptor<T,EQ>{
