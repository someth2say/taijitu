...
//                new String[]{ParallelQueryingMappingStrategy.NAME}
    ...
    public void genericTest() throws QueryUtilsException, TaijituException, SQLException, ConfigurationException {
        ...
        final SimpleComparisonResult[] comparisonResults = new Taijitu().compare(ConfigurationUtils.unmodifiableConfiguration(ConfigurationUtils.convertToHierarchical(config)));
