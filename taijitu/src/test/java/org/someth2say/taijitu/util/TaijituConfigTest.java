...
public class TaijituConfigTest {
    ...
    public void testParameters() {
        ...
        assertEquals("Explicit setup parameter must be set", "test1Param", TaijituConfigImpl.getParameter("1", "test1Param"));
        assertEquals("Explicit non-setup parameter must be set", "test1Param2", TaijituConfigImpl.getParameter("1", "test1Param2"));
        assertEquals("Overwritten parameter must be set", "overwrittenParamInTest", TaijituConfigImpl.getParameter("1", "overwrittenParam"));
        assertEquals("Global parameter must be set", "globalParam", TaijituConfigImpl.getParameter("1", "globalParam"));
        assertEquals("Non-defined param should not be set ", null, TaijituConfigImpl.getParameter("1", "undefined"));
        ...
        assertEquals("Parameters set in one test should not spread to other tests", "test2Param", TaijituConfigImpl.getParameter("2", "test2Param"));
        assertEquals("Parameters set in one test should not be available in other test", null, TaijituConfigImpl.getParameter("2", "test1Param2"));
