 ...
 *         Two object with same hash values can be ordered any way.
 *         Two objects with same ordering (that is, `comparatorHasher.compareTo(a,b)==0`) may or may not have the same hash code.
 *     </li>
 * </ul>
 *
 */
