...
import org.someth2say.taijitu.config.apache.defaults.ApacheTaijituConfig;

import static org.someth2say.taijitu.config.DefaultConfig.DEFAULT_LIST_DELIMITER;

public class ApacheTaijitu extends ApacheComparison implements ApacheTaijituConfig {

    public ApacheTaijitu(ImmutableHierarchicalConfiguration configuration, ApacheTaijituConfig parent) {
    ...
    public static ApacheTaijitu fromFile(final String file) throws TaijituException {
        ...
        return new ApacheTaijitu(config, null);
    }
