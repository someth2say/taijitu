...
public final class TaijituCli {
    ...
    public static List<Stream<Difference<?>>> compare(final ITaijituCfg config) throws TaijituCliException {
        ...
        final CompletionService<Stream<Difference<?>>> completionService = runComparisons(threads, comparisons);

        // Collect results
        final List<Stream<Difference<?>>> result = getResults(completionService, comparisons.size());
    ...
    private static CompletionService<Stream<Difference<?>>> runComparisons(Integer threads, List<IComparisonCfg> comparisons) {
    ...
    private static List<Stream<Difference<?>>> getResults(CompletionService<Stream<Difference<?>>> completionService, int size) {
        final List<Stream<Difference<?>>> result = new ArrayList<>(size);
